...
let imageList = ['/create-ui-based-on-a-database/frontend-ui/img/img-1.jpg', '/create-ui-based-on-a-database/frontend-ui/img/img-2.jpg', '/create-ui-based-on-a-database/frontend-ui/img/img-3.jpg', '/create-ui-based-on-a-database/frontend-ui/img/img-4.jpg', '/create-ui-based-on-a-database/frontend-ui/img/img-5.jpg', '/create-ui-based-on-a-database/frontend-ui/img/img-6.jpg', '/create-ui-based-on-a-database/frontend-ui/img/img-7.jpg', '/create-ui-based-on-a-database/frontend-ui/img/img-8.jpg']; // List of all(!) the images' paths.
